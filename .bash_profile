...
alias dot-update="cd ~/workspace/dotiles && git pull && cp ~/.bash_profile ._bash_profile && cp
~/.vimrc ._vimrc && cp ~/.gitignore ._gitignore && git add --all  && git commit -m \"update\" && git push"
